...
RSpec.describe "/comments", type: :request do
  ...
  describe "should display all user comments" do
  ...
  describe "should display first comment at /comments/:id" do
    it "should return the comment based on given param" do
      get "/comments/1"
      expect(response).to have_http_status(:success)
